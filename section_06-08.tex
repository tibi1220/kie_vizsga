...
\begin{document}
  ...
  \begin{itemize}
    ...
    rendszerének matematikai, logikai \zkod{modell}je
  ...
  \begin{itemize}
    ...
    \item $n$ darab azonos típusú \zkod{adatelem}ből áll
    
    \item az elemekre \zkod{indexhalmaz}zal hivatkozunk
  ...
  \fogalom{Verem}
  \begin{itemize}
    \item a \zkod{verem} (\kkod{stack}) \zkod{LIFO}
    típusú tároló.
  ...
  \fogalom{Sor}
  \begin{itemize}
    \item a \zkod{sor} (\kkod{queue}) \zkod{FIFO}
    típusú tároló.
