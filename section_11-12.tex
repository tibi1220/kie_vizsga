...
\begin{document}
    ...
    \begin{figure}[H]
      ...
      \begin{circuitikz}[american, thick]
        \tikzset{mux 4by2/.style={muxdemux,
          ...
          \draw (0,0) node [mux 4by2] (mux1) {\small\kkod{MUX}}
  ...
  \begin{minipage}[c]{0.2\textwidth}
    \begin{figure}[H]
      ...
      \begin{circuitikz}[american, thick]
        ...
        \draw (0,0) node [demux 2by4] (demux1) {\small\kkod{DEMUX}}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item tartalom szerinti hozzáférés (\zkod{cache})
    \end{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item nagy integráltságú, a \zkod{PC}-k memóriája ilyen
    \end{itemize}
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \zkod{mnemonik}kal helyettesíti
    \end{itemize}
  ...
  el kell menteni a \zkod{PC} (utasításszámláló)
  értékét a \kkod{stack}-be (\kkod{PUSH})
  ...
  adatátvitel. A \zkod{DMA vezérlő} irányítja az
  adatforgalmat, így a \zkod{CPU} közben egy
