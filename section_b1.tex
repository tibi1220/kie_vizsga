...
\begin{document}
  ...
  \begin{itemize}
    ...
    \zkod{ekvivalens} valamely Turing-géppel.
  ...
  \begin{itemize}
    ...
    \item \zkod{SQR} – meglévő adatok lekérdezése, módosítása
  ...
  \begin{itemize}
    \item az \zkod{ETK adatmodell} a fenti három fogalom együttese
  ...
  \begin{itemize}
    ...
    \begin{figure}[H]
      ...
      \begin{tikzpicture}[node distance=8em]
        ...
        \node[relationship] (rel1) [right of=ent1] {Kapcsolat${}_1$} edge (ent1);
        \node[attribute] (attr1) [below left of=rel1] {\key{Kulcstul}} edge[<-] (rel1);
        \node[attribute] (attr2) [below of=rel1] {Többértékű} edge[<<-] (rel1);
        \node[attribute] (attr3) [below right of=rel1] {\xcancel{Összetett}} edge[<-] (rel1);
        \node[entity] (ent2) [right of=rel1] {Egyed${}_2$} edge (rel1);
        \node[relationship] (rel2) [right of=ent2] {Kapcsolat${}_2$} edge (ent2);
        \node[attribute] (attr4) [below of=rel2] {Egyszerű} edge[<-] (rel2);
        \node[attribute] (attr5) [below right of=rel2] {Egyértékű} edge[<-] (rel2);
      \end{tikzpicture}
    \end{figure} %tikz
  ...
  (\zkod{N-M}) kapcsolatot és leírrhatunk.
  ...
  \begin{itemize}
    ...
    \item \zkod{mező} \tabto{2.5cm} – \tabto{3.2cm} a
  ...
  \begin{itemize}
    \item \kkod{SELECT} \fkod{coulomn1, column2, \dots}
    ...
    \item \kkod{SELECT} \fkod{expression coulomn,\dots}
